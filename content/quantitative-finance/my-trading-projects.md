...
What I will do is give an honest account of: what the work is, at the level of methods and research questions rather than specific signals; what I have learned from it; and what the current direction is. This is the standard practice — nobody who has built something that works is going to post it on a website.
